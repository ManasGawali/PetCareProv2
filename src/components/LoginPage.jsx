...
export function LoginPage({ onSignIn, onNavigateToSignUp, demoAccounts }) {
  ...
  const handleSocialLogin = (provider) => {
    ...
    // For demo purposes, sign in with the first demo account
    const demoUser = demoAccounts[0];
    onSignIn(demoUser.email, demoUser.password);
  };

  const copyAccountDetails = (account) => {
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-[#333333]">Continue with Facebook</span>
              </motion.button>
            </motion.div>
